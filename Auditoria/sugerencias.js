export default [
    {
        titulo: `
            Lenguaje en el Encabezado de las Tablas
        `,
        contenido: `
    ...
    },
    {
        ...
        `,
        contenido: `
            Al generar el reporte de "Información Registradora", el título que aparece en la interfaz gráfica utiliza lenguaje de programador, como "Listado de Auditorías - tbl_auditoria_informacion_registradora". Esto debería corregirse utilizando un lenguaje más natural y amigable para el usuario.
            
            <div class="flex-center-wrap">
                <img class="miniatura" src="https://i.ibb.co/GTgtqS3/Captura-de-pantalla-2023-08-24-095114.png" data-lightbox-group="3" loading="lazy">
                <img class="miniatura" src="https://i.ibb.co/JmQP1FG/Captura-de-pantalla-2023-08-24-095132.png" data-lightbox-group="3" loading="lazy">
            </div>
        `
    },
    {
        titulo: `
            En algunos casos hay problema de margenes
        `,
        contenido: `
            Específicamente, se observa que hay un exceso de espacio en el lado izquierdo, mientras que el contenido rebasa los márgenes en el lado derecho de la tabla.
            <div class="flex-center-wrap">
                <img class="miniatura" src="https://i.ibb.co/9qJyr5S/Captura-de-pantalla-2023-08-24-094115.png" data-lightbox-group="4" loading="lazy">
            </div>
        `,
    },
]